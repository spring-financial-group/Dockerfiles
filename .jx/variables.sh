...
export JENKINS_X_URL='https://dashboard-jx.jx.mqube.build/spring-financial-group/Dockerfiles/main/34'
...
export MINK_IMAGE='jx3mqubebuild.azurecr.io/spring-financial-group/Dockerfiles:0.4.16'
